"""Probe the fixed-step sparse Jacobian for the sorbing-boundary scenario.

Records whether the injected num_jac is actually called, how large scipy's jac
factor would have grown, and the resulting mass-balance residual, for a few
relative steps. Diagnostic island: writes one JSON next to itself, changes nothing.
"""
...
import scipy.integrate._ivp.common as common  # noqa: E402
